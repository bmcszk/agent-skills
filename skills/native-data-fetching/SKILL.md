...
- [Expo Router Loaders](references/expo-router-loaders.md) — Route-level data loading with Expo Router
- [Example Invocations](references/example-invocations.md) — Common user questions and how to invoke this skill
